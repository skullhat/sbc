...
public class TripPanelDisplay extends JPanel {
        JPanel body;
        String[][] rec;
        JLabel add_trip;
        ...
        TripPanelDisplay() {
                ...
                try {
                        ...
                        JOptionPane.showMessageDialog(TripPanelDisplay.this,
                                        e.getMessage(),
                                        "Try again",
        ...
        // return body;
        // }
        public static String[][] getDatabaseRows() throws Exception {
                String[][] result = null;
                ...
                try {
                        ...
                        PreparedStatement stmt = conn.prepareStatement("Select * from trips where 1",
